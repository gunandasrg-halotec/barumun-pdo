...
class DashboardService
{
    ...
    public function summary(User $user): array
    {
        ...
        // Total transfer & realisasi bulan ini (seluruh unit)
        ...
        return [
            ...
            'total_transferred' => (int) $monthlyStats->total_transferred,
            'total_realized'    => (int) $monthlyStats->total_realized,
            'pending_approval'  => $pendingForUser,
        ];
    }
