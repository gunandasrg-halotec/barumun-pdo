...
| FR-02-020 | Binding user ke Unit Kebun: **Kerani dan Asisten Kebun** wajib terikat pada tepat satu Unit Kebun (bukan HO) dan hanya dapat mengakses data PDO unit tersebut. Semua role lain (**Manajer Kebun, Manajer Keuangan, Staff Keuangan, Direktur Keuangan, Staff Purchasing, Admin**) adalah pengguna lintas unit dan di-assign ke **unit HO (Head Office)** — dapat mengakses data PDO semua unit | Must Have |
| FR-02-020a | Sistem menyediakan **unit HO (Head Office)** sebagai unit khusus yang merepresentasikan kantor pusat. User yang di-assign ke unit HO diperlakukan sebagai pengguna lintas unit. Kerani dan Asisten Kebun tidak dapat di-assign ke unit HO | Must Have |
...
| 1.8 | 21 Juni 2026 | **Unit HO dan aturan binding role:** FR-02-020 diperbarui — Kerani dan Asisten Kebun wajib terikat unit kebun spesifik (bukan HO); semua role lain (Manajer Kebun, Manajer Keuangan, Staff Keuangan, Direktur Keuangan, Staff Purchasing, Admin) di-assign ke unit HO sebagai pengguna lintas unit. FR-02-020a (baru): sistem menyediakan unit HO sebagai unit khusus Head Office; Kerani dan Asisten Kebun tidak dapat di-assign ke unit HO | Tim Product |
